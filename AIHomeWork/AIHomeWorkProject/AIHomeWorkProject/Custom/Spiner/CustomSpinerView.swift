...
class CustomSpinerView: UIView {
    ...
    private func setupLayers() {
        ...
        backgroundLayer.strokeColor = UIColor.appActiveLight.cgColor
        ...
        spinnerLayer.strokeColor = UIColor.appActive.cgColor
