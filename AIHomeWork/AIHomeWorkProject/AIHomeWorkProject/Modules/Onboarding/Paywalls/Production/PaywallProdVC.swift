...
final class PaywallProdVC: UIViewController {
    ...
    private lazy var subTitleLabel: UILabel =
        .prodSubTitleLabel(Constants.subTitleText(with: viewModel.weaklyPrice))
    ...
    init(viewModel: PaywallProdViewModelProtocol, pageControlIsHiden: Bool) {
...
extension PaywallProdVC {
    ...
    private func bind() {
        ...
        viewModel.changeWeaklyText = { [weak subTitleLabel] price in
