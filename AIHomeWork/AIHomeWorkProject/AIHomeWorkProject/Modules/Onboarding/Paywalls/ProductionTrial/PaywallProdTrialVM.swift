...
final class PaywallProdTrialVM {
    ...
    var changeTrialText: ((_ price: String) -> Void)?
    
    weak var coordinator: PaywallProdTrialCoordinatorProtocol?
    ...
    init(coordinator: PaywallProdTrialCoordinatorProtocol,
        ...
        self.trialPrice = adaptyService.productTrialPrice ?? ""
...
extension PaywallProdTrialVM: PaywallProdTrialViewModelProtocol {
