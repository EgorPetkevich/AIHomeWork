//
//  OnboardingProdThirdStepVC.swift
//  AIHomeWorkProject
//
...
protocol OnboardingProdThirdStepProdViewModelProtocol {
    
    func activityButtonDidTap()
}

final class OnboardingProdThirdStepVC: UIViewController {
    ...
    private enum Constants {
        ...
        static let currentPage: Int = OnboardingManager.ProductionOnboardingPage.third.rawValue
        
    }
    
    private let viewModel: OnboardingProdThirdStepProdViewModelProtocol
    ...
    init(viewModel: OnboardingProdThirdStepProdViewModelProtocol) {
...
extension OnboardingProdThirdStepVC {
